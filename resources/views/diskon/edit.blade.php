        ...
        <div class="card-body">
            ...
            <form action="{{ route('diskon.update', $diskon->id_diskon) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('persentase') is-invalid @enderror" id="persentase" name="persentase" value="{{ old('persentase', $diskon->persentase) }}" step="0.01">
                    @error('persentase')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('nominal') is-invalid @enderror" id="nominal" name="nominal" value="{{ old('nominal', $diskon->nominal) }}" step="1000">
                    @error('nominal')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
