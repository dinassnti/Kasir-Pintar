...
<div class="container mt-5">
    ...
    <form action="{{ route('data_staff.store') }}" method="POST">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="password" name="password_confirmation" id="password_confirmation" class="form-control shadow-sm @error('password_confirmation') is-invalid @enderror" required>
        ...
        <div class="mb-4">
            ...
            <select name="level_akses" id="level_akses" class="form-control shadow-sm @error('level_akses') is-invalid @enderror" required>
                <option value="" disabled selected>Pilih Level Akses</option>
                <option value="Kasir" {{ old('level_akses') == 'Kasir' ? 'selected' : '' }}>Kasir</option>
            </select>
            @error('level_akses')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
